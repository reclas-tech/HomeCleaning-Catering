<x-tampilanLayout>
    ...
    <div
        ...
        <div class="lg:w-[40%] md:w-[70%] sm:w-full flex flex-col ml-16 mr-16 mb-20 text-start">
            ...
            <p class="text-base font-thin text-white mt-4">ini merupakan organigram dari SweepMop Home Cleaning
            </p>
        </div>
    ...
    <div class="w-full flex flex-col justify-center items-center mt-36 mb-36">
        <div class="w-[80%] bg-[#FA8F21] p-10 rounded-lg">
            ...
            <p class="text-sm md:text-base font-thin text-white text-justify md:text-center mt-4 m-2 md:m-8 pl-0 md:pl-24 md:pr-24">Perusahaan yang
