<x-tampilanLayout>
    <x-heroTampilan title="PT. ElyNaz IndoMasr Global "
        ...
        ref="/" imgPath="{{asset('assets/tampilanAssets/firstHome.png')}}" />
    ...
    <div class="flex flex-col md:flex-row md:justify-between items-center md:min-h-screen md:px-10 bg-[#0062D1] p-5">
        ...
        <div id="default-carousel" class="relative w-full bg-white p-2" data-carousel="slide">
            ...
            <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src={{asset('assets/tampilanAssets/bannerDynamic.png')}}
                        class="absolute block sm:w-[75%] md:w-[90%] -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                        alt="...">
                </div>
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src={{asset('assets/tampilanAssets/bannerDynamic2.png')}}
                        class="absolute block sm:w-[75%] md:w-[90%] -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                        alt="...">
                </div>
            </div>
        ...
        {{-- <div id="default-carousel" class="relative w-full bg-white p-2" data-carousel="slide">
            ...
            <div class="relative h-56 overflow-hidden rounded-lg md:h-[30rem]">
                <!-- Item 1 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src={{asset('assets/tampilanAssets/bannerDynamic.png')}} class="absolute block w-[90%]
        -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
    </div>
    <!-- Item 2 -->
    <div class="hidden duration-700 ease-in-out" data-carousel-item>
        <img src={{asset('assets/tampilanAssets/bannerDynamic2.png')}}
            class="absolute block w-[90%] -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
    </div>
    </div>
    <!-- Slider controls -->
    <button type="button"
