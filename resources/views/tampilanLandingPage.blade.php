        ...
        <div class="max-w-sm p-4 rounded-lg shadow bg-[url({{asset('assets/tampilanAssets/cardCleaning.png')}})] bg-cover">
            ...
            <div class="bg-white/[0.16] p-3 rounded-md h-fit">
                ...
                <div class="flex justify-end">
                    <x-cmsButton ref="/cleaning" color="#FA8F21" width="36" title="Lihat Selengkapnya" extendClass="text-white text-center mt-6 "/>
                </div>
            </div>
        </div>
        <div class="max-w-sm p-4 rounded-lg shadow bg-[url({{asset('assets/tampilanAssets/cardCleaning.png')}})] bg-cover ">
            ...
            <div class="bg-white/[0.16] p-3 rounded-md h-fit">
                ...
                <div class="flex justify-end">
                    <x-cmsButton ref="/catering" color="#FA8F21" width="36" title="Lihat Selengkapnya" extendClass="text-white text-center mt-6 "/>
                </div>
            </div>
        </div>
    </div>
