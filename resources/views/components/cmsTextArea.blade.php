<div class="mb-4">
    ...
    <div class="relative">
        <textarea id="{{$id}}" rows="4" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-black bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-bg-[#0062D1] focus:outline-none focus:ring-0 focus:border-bg-[#0062D1] peer"
