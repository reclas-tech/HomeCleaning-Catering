<script>
    // alertDataEditedSuccessfully.y
    function alertDataEditedSuccessfully(title, message) {
        const modalContainer = document.getElementById("modalContainer");
        const modal = document.createElement("div");
        modal.id = "customModal";
        modal.className =
            "hidden fixed bottom-0 right-0 bg-opacity-75 bg-white flex justify-center items-center mb-14 mr-12";
        modal.innerHTML = `
        ...
        <div class="w-60 h-14 px-4 py-2.5 bg-white rounded shadow justify-between items-center inline-flex">
            <div class="h-9 relative">
                <div class="w-52 h-9 left-0 top-0 absolute justify-between items-center gap-4 inline-flex">
                    ...
                    <div class="w-full text-center text-base font-semibold ">${title || "Data Edited Successfully"}</div>
